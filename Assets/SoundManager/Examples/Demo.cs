...
public class Demo : MonoBehaviour {
    ...
    public void Start()
    {
        pausePanel.transform.Find("MusicSlider").GetComponent<Slider>().value = SoundManager.GetMusicVolume();
        pausePanel.transform.Find("SoundSlider").GetComponent<Slider>().value = SoundManager.GetSoundVolume();
