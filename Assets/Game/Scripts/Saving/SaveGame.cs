...
namespace Saving
{
    ...
    public class SaveGame
    {
        ...
        private LevelChangeObserver.allScenes IdSceneForPortal = LevelChangeObserver.allScenes.emptyScene;
        ...
        {
            if (IdSceneForPortal == LevelChangeObserver.allScenes.emptyScene || IGame.Instance.dataPlayer.playerData.FinishedRegionsIDs.Contains((int)IdSceneForPortal))
                return;
            ...
            bonusWeapon = null;
            bonusArmor = null;
            IdSceneForPortal = LevelChangeObserver.allScenes.emptyScene;
        }
